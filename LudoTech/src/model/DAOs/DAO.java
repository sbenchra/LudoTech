...
public abstract class DAO {
	...
	/**
	 * Constante définissant l'URL à utiliser par JDBC pour accéder à la base de données
	 */
	...
	/**
	 * Représentation de la connection à la base de données. Elle peut-être nulle (jamais utilisée) ou ouverte/fermée.
	 */
	 ...
	 * @param schemaToUse Le nouveau nom à utiliser
	 */
	...
	/**
	 * Connecte l'application à la base de données embarquée et définie quel schéma à utiliser pour cette connection
	 * @throws SQLException S'il est impossible d'obtenir une connection à la base de données (souvent dû à une utilisation parallèle)
	 */
